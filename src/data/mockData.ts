...
export const mockActivities: Activity[] = [
  {
    ...
    username: 'ShadowBlade',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ShadowBlade',
    description: 'You played Elden Ring',
    metadata: {
      gameId: 'game_001',
      gameName: 'Elden Ring',
      duration: 120,
  ...
  },
  {
    ...
    username: 'NightHawk',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=NightHawk',
    description: 'NightHawk unlocked "Dragon Slayer"',
    metadata: {
  ...
  },
  {
    ...
    username: 'PixelQueen',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=PixelQueen',
    description: 'PixelQueen reached Level 55',
    metadata: {
      newLevel: 55,
    },
  ...
  },
  {
    ...
    username: 'StormRider',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=StormRider',
    description: 'StormRider played Valorant for 3 hours',
    metadata: {
      gameId: 'game_003',
      gameName: 'Valorant',
      duration: 180,
  ...
  },
  {
    ...
    username: 'ShadowBlade',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ShadowBlade',
    description: 'You reached Diamond rank!',
    metadata: {
      newRank: 'Diamond',
      gameName: 'Valorant',
    },
